...
Revision ID: 3f829b05495f
Revises: 
Create Date: 2026-02-26 19:14:12.568302+00:00
"""
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_model_providers_organization_id'), 'model_providers', ['organization_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_model_providers_organization_id'), table_name='model_providers')
